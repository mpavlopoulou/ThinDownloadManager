...
public class ThinDownloadManager implements DownloadManager {
    ...
    @Override
    public void setUntrustedCertificatePolicy(boolean shouldAcceptUntrustedCertificate) {
        if(shouldAcceptUntrustedCertificate){
            TrustCertificateHelper helper = new TrustCertificateHelper();
            helper.trustAllCertificates();
        }
    }
